"""
    This script is intended to create a csv file for train and test portions of the dataset,
    containing information such as video name and path, object and action class for now.

    Author: Ali Ghelmani,       Date: Dec. 2021
"""
import sys
sys.path.append('/home/path/to/CVRL_Excavator')
import pandas as pd
...
def create_train_test_vid_list(config):
    """
        ...
        name, video dir, etc. in a list which is then divided into train, eval, and test datasets based on
    ...
    save_path = save_path.joinpath(f"save_dir")
...
if __name__ == "__main__":
    create_train_test_vid_list(cvrl_config)
